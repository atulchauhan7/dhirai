...
function handleFloCheckoutBtn(trigger){
...
window.handleFloCheckoutBtn=handleFloCheckoutBtn;
window.handleFloBuyNowBtn=handleFloBuyNowBtn;
...
h+='<form action="/cart" method="post" novalidate class="cart-drawer__checkout-form"><button type="button" name="checkout2" class="btn btn--primary btn--full" onclick="handleFloCheckoutBtn(event)">Checkout</button></form>';
